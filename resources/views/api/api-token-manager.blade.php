    ...
    <x-form-section submit="createApiToken">
        ...
        <x-slot name="form">
            ...
            <div class="col-span-6 sm:col-span-4">
                <x-label for="prenom" value="{{ __('Token Prenom') }}" />
                <x-input id="prenom" type="text" class="mt-1 block w-full" wire:model.defer="createApiTokenForm.name" autofocus />
                <x-input-error for="prenom" class="mt-2" />
            </div>
            <div class="col-span-6 sm:col-span-4">
                <x-label for="nom" value="{{ __('Token Nom') }}" />
                <x-input id="nom" type="text" class="mt-1 block w-full" wire:model.defer="createApiTokenForm.name" autofocus />
    ...
    @if ($this->user->tokens->isNotEmpty())
        ...
        <div class="mt-10 sm:mt-0">
            <x-action-section>
                ...
                <x-slot name="content">
                    <div class="space-y-6">
                        @foreach ($this->user->tokens->sortBy('prenom') as $token)
