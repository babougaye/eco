...
<div class="container">
    ...
    <h1 style="text-align: center; font-size: 24px; padding-bottom:20px;"> Paiement par carte - Montant total {{$totalprix}}</h1>
        ...
        <div class="col-md-6 col-md-offset-3">
            <div class="panel panel-default credit-card-box">
                ...
                <div class="panel-body">
                    ...
                    <form
                            role="form"
                            action="{{ route('stripe.post',$totalprix) }}"
                            method="post"
                        ...
                        <div class='form-row row'>
                            <div class='col-md-12 error form-group hide'>
                                <div class='alert-danger alert'>Veuillez corriger les erreurs et réessayer.
                                    </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <input type="submit" name="" value="Payer maintenant">
                            </div>
                        </div>
